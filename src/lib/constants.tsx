      ...
      >
        <div ref={ref} className="flex items-center justify-center whitespace-nowrap">
          ...
          >
			...
			{
				title: "Usage",
				code: `import { AnimatedWidthContainer } from '@/components/ui/animated-width-container'
...
export function Example() {
  ...
  return (
    <AnimatedWidthContainer 
      onClick={() => setWidthIndex((prev) => (prev + 1) % labels.length)}
    >
      {labels[widthIndex]}
    </AnimatedWidthContainer>
  )
...
export function AnimatedHeightContainer({
  ...
  return (
    ...
    >
      <div className={cn("border-border bg-background flex w-full max-w-md flex-col gap-3 rounded-xl border p-5", className)}>
        <motion.div
          animate={{
        ...
        {expandedContent && (
          <>
			...
			{
				title: "Usage",
				code: `import { AnimatedHeightContainer } from '@/components/ui/animated-height-container'
...
export function Example() {
  const expandedContent = (
    ...
    >
      <Paragraph>
        This technique uses a ref to track the height of the inner content.
      </Paragraph>
    </motion.div>
  )
  ...
  return (
    ...
    >
      <Paragraph>
        Containers on the web snap to their new size instantly.
      </Paragraph>
    </AnimatedHeightContainer>
  )
}`,
